...
1. Query GitHub for issues assigned to `botfleet-audit`:
   ```
...
6. **Log rotation**: If today's log exceeds 50 MB, rotate to `logs/<date>-audit-bot-<n>.log`.
...
2. **Generate daily summary**:
   - Write `logs/<date>-audit-bot-summary.md` with:
