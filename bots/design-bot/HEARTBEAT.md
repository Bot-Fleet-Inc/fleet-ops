...
1. Query GitHub for issues assigned to `botfleet-design`:
   ```
...
6. **Log rotation**: If today's log exceeds 50 MB, rotate to `logs/<date>-design-bot-<n>.log`.
...
2. **Generate daily summary**:
   - Write `logs/<date>-design-bot-summary.md` with:
