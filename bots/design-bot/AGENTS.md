# 🎨 design-bot — Operational Configuration

## Issue Polling

design-bot polls GitHub for assigned work on a fixed interval.

### Primary Query

```
is:issue is:open assignee:botfleet-design org:Bot-Fleet-Inc
```

- **Interval**: 60 seconds
- **Method**: `gh search issues --assignee=botfleet-design --state=open --limit=50`
...
```
is:issue is:open label:bot:design-bot org:Bot-Fleet-Inc
```
...
design-bot operates under the **DMZ** security tier. The following access rules apply:
...
10. Log startup: `🎨 design-bot online — session started at <timestamp>`.
11. Begin main loop.
...
2. Post comment on any in-progress issues: `🎨 design-bot going offline — will resume on restart`.
