...
gh search issues --assignee=botfleet-design --state=open --limit=50

# Read issue details
gh issue view <number> --repo Bot-Fleet-Inc/<repo> --json title,body,labels,assignees,comments

# Comment on issue
gh issue comment <number> --repo Bot-Fleet-Inc/<repo> --body "🎨 **design-bot**: <message>"

# Close issue with summary
gh issue close <number> --repo Bot-Fleet-Inc/<repo> --comment "🎨 **design-bot**: Completed. <summary>"
...
gh issue edit <number> --repo Bot-Fleet-Inc/<repo> --add-assignee <other-bot> --remove-assignee botfleet-design
```
...
# Review PR
gh pr review <number> --repo Bot-Fleet-Inc/<repo> --approve --body "🎨 **design-bot**: Approved. <reason>"
gh pr review <number> --repo Bot-Fleet-Inc/<repo> --request-changes --body "🎨 **design-bot**: Changes requested. <details>"
...
| High (design analysis) | Claude Sonnet | Anthropic API |
...
Skills from the enterprise-continuum repository that design-bot may reference or invoke:
...
| `BOT_NAME` | This bot's name (`design-bot`) |
| `BOT_ROLE` | This bot's role (`Logo, brand guide, UI design`) |
