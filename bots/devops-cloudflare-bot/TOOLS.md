# ☁️ devops-cloudflare-bot — Available Tools
...
gh search issues --assignee=botfleet-devcloudflare --state=open --limit=50

# Read issue details
gh issue view <number> --repo Bot-Fleet-Inc/<repo> --json title,body,labels,assignees,comments

# Comment on issue
gh issue comment <number> --repo Bot-Fleet-Inc/<repo> --body "☁️ **devops-cloudflare-bot**: <message>"

# Close issue with summary
gh issue close <number> --repo Bot-Fleet-Inc/<repo> --comment "☁️ **devops-cloudflare-bot**: Completed. <summary>"
...
gh issue edit <number> --repo Bot-Fleet-Inc/<repo> --add-assignee <other-bot> --remove-assignee botfleet-devcloudflare
```
...
# Review PR
gh pr review <number> --repo Bot-Fleet-Inc/<repo> --approve --body "☁️ **devops-cloudflare-bot**: Approved. <reason>"
gh pr review <number> --repo Bot-Fleet-Inc/<repo> --request-changes --body "☁️ **devops-cloudflare-bot**: Changes requested. <details>"
...
Skills from the enterprise-continuum repository that devops-cloudflare-bot may reference or invoke:
...
| `BOT_NAME` | This bot's name (`devops-cloudflare-bot`) |
| `BOT_ROLE` | This bot's role (`Workers, Pages, DNS, Tunnels`) |
