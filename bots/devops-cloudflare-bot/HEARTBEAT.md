# ☁️ devops-cloudflare-bot — Heartbeat Schedule
...
1. Query GitHub for issues assigned to `botfleet-devcloudflare`:
   ```
...
6. **Log rotation**: If today's log exceeds 50 MB, rotate to `logs/<date>-devops-cloudflare-bot-<n>.log`.
...
2. **Generate daily summary**:
   - Write `logs/<date>-devops-cloudflare-bot-summary.md` with:
