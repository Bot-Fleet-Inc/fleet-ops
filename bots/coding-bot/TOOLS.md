...
# Comment on issue
gh issue comment <number> --repo Bot-Fleet-Inc/<repo> --body "💻 **coding-bot**: <message>"

# Close issue with summary
gh issue close <number> --repo Bot-Fleet-Inc/<repo> --comment "💻 **coding-bot**: Completed. <summary>"
...
gh issue edit <number> --repo Bot-Fleet-Inc/<repo> --add-assignee <other-bot> --remove-assignee botfleet-coding
```
...
# Review PR
gh pr review <number> --repo Bot-Fleet-Inc/<repo> --approve --body "💻 **coding-bot**: Approved. <reason>"
gh pr review <number> --repo Bot-Fleet-Inc/<repo> --request-changes --body "💻 **coding-bot**: Changes requested. <details>"
...
| High (code review, multi-file) | Claude Sonnet | Anthropic API |
...
Skills from the enterprise-continuum repository that coding-bot may reference or invoke:
...
| `BOT_NAME` | This bot's name (`coding-bot`) |
| `BOT_ROLE` | This bot's role (`Code review and implementation`) |
